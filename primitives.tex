...
Hence, $\Enc$, the encryption algorithm, takes a message and key as input and outputs an obfuscated message. 
...
\al{add more here - like how adversary can encrypt any message they want}
\al{also add that an encryption scheme is formally the tuple $\Pi$}
...
\al{paragraph to transition to indistinguishability} 

\al{paragraph with high level explanation of indistinguishability}
...
For concreteness, imagine that ... \al{maybe use random ~ random numbers I pick example}
