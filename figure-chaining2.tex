...
\scalebox{1.0}{
    ...
    \caption[Overview of component-based garbled circuits with link labels]{An example of linking component $c_0$ to component $c_1$. The link labels for linking the output wires of $c_0$ and the input wires of $c_1$ are shown between the wires in blue.}
\label{fig:chaining2}
\end{figure}
