...
\scalebox{1.0}{
    ...
    \caption[Overview of component-based garbled circuits]{An example of linking component $c_0$ to component $c_1$. The output wires of $c_1$, $U_0, U_1$ and $U_2$, are linked to the input wires of $c_1$, $W_0, W_1$ and $W_2$.}
                            \label{fig:chaining}
\end{figure}
