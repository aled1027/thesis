...
At a high level, Yao's scheme works by having Alice build the corresponding circuit for $f$, encrypting the circuit gate by gate, sending the encrypted circuit to Bob, who uses values corresponding to the inputs to decrypt the circuit.
