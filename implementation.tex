...
We use the Levensthein core circuit, as described by \cite{faster2pc}, as the only component; see figure \ref{fig:leven-core} for a description of the component.
...
However, this is a common method of reporting times in the literature \cite{blazing-fast} \al{probably add another reference}.
